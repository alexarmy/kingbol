...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/alexarmy/veryfast/main/user.txt').text
    if to in r:
...
def menu():
    ...
    print ' ------------------------------------------ '
    print '\x1b[1;94m[1] Crack with Auto Hittler Number password 10'
    print '\x1b[1;94m[2] Crack with Hittler Number password 6'
    print '\x1b[1;94m[3] Crack with Hittler Name + Number password 8'
...
def crack():
    ...
    os.system('clear')
    print logo
    print '\x1b[1;93m~~~~ Auto pass Hittler Number cracking ~~~~\x1b[1;91m'
    print 47 * '-'
