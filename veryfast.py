...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/alexarmy/veryfast/main/server.txt').text
    if to in r:
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80ALEX-PRINCE\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
